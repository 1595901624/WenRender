        ...
        <ScrollArea.Viewport className="h-full w-full overflow-x-hidden overscroll-contain px-1 pb-4 [&>div]:!block [&>div]:!min-w-0 [&>div]:!w-full">
                ...
                >
                  ...
                  {standaloneDocuments.length > 1 && (
                    <span
                      role="button"
                      tabIndex={0}
                      className="rounded p-0.5 opacity-0 hover:bg-stone-200 group-hover:opacity-100"
          ...
          {directories.length > 0 && (
            <div className="mb-1 mt-5 flex items-center justify-between px-2">
              ...
              <button
                className="inline-flex items-center gap-1 rounded-md px-1.5 py-1 text-[10px] text-stone-500 hover:bg-stone-200"
          ...
          <button
            ...
            className={clsx(
              ...
              node.path === activePath
                ...
                : node.isMarkdown
                  ? "text-stone-600 hover:bg-[#eaeae7]"
